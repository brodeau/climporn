...
def fig_style_mov( pzoom, clr_top='k', clr_top_cb='k' ):
    ...
    fig_style_mov.cfont_clock    = { 'fontname':'Ubuntu Mono', 'fontweight':'normal', 'fontsize':int(11.*pzoom), 'color':clr_top }
    ...
    fig_style_mov.cfont_titl     = { 'fontname':'Open Sans'  , 'fontweight':'normal', 'fontsize':int(20.*pzoom), 'color':clr_top }
