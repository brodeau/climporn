...
def fig_style_mov( pzoom, clr_top='k', clr_top_cb='k' ):
    ...
    rcParams.update(params)
    fig_style_mov.cfont_clb_tcks = { 'fontname':'Ubuntu Mono', 'fontweight':'normal', 'fontsize':int(12.*pzoom), 'color':clr_top_cb}
    fig_style_mov.cfont_clb      = { 'fontname':'Open Sans',   'fontweight':'normal', 'fontsize':int(12.*pzoom), 'color':clr_top_cb}
