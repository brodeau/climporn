...
class nemo_hbox:
    ...
    def idx(self):
        ...
        if   [ config, box ] == [ 'ORCA36', 'ALL']:
            ...
            i1=0 ; j1=54 ; i2=Ni0-20 ; j2=Nj0-100  ; rfact_zoom=1 ; font_rat=1.*rfact_zoom
            l_show_cb  = True ; vcb=[0.3, 0.96, 0.4, 0.016]
            l_show_clock=True ; x_clock = rfact_zoom*2310 ; y_clock = rfact_zoom*3000
            l_show_sign=True  ; x_sign = rfact_zoom*3000 ; y_sign = rfact_zoom*15
            pt_sz_track = 1
            #
