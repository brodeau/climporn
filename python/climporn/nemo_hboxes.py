...
class nemo_hbox:
    ...
    def idx(self):
        ...
        if   [ config, box ] == [ 'ORCA36', 'ALL']:
            ...
            ####   NANUK12   ####
        elif [ config, box ] == [ 'NANUK12', 'ALL']:
            i1=0 ; j1=0  ;  i2=Ni0 ; j2=Nj0  ; rfact_zoom=1. ; font_rat=0.8*rfact_zoom
            l_show_cb  = True ; vcb=[0.57, 0.965, 0.4, 0.016]; loc_cb = 'land'
            l_show_clock=True ; x_clock = rfact_zoom*1180; y_clock = rfact_zoom*1460
            l_show_name=False  ; x_name  = rfact_zoom*60 ; y_name  = rfact_zoom*1260
            l_show_exp=False  ; x_exp   = rfact_zoom*140 ; y_exp   = rfact_zoom*1250 
            l_add_logo=False  ; l_fill_holes_k=False
            ...
            l_add_logo=False
            l_show_name=False ; x_name = rfact_zoom*15 ; y_name = rfact_zoom*430
            l_show_exp=False ; x_exp = 50 ; y_exp = 80
            l_fill_holes_k=False
